...
export const ServiceArea = () => {
  const pills = [BUSINESS.city, ...BUSINESS.neighbors, BUSINESS.county, "And More"];
  return (
    <section className="bg-ink px-6 md:px-10 py-20">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <h2 className="font-display text-chalk text-[40px] md:text-[52px] leading-none">
          SERVING {BUSINESS.city} &amp; BEYOND.
        </h2>
        <p className="text-fog mt-4" style={{ fontSize: 15 }}>
          We serve {BUSINESS.city}, {BUSINESS.county}, and all surrounding communities. Not sure if we cover your area? Call us — if we can get there, we will.
        </p>
